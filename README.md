...
The weather icons in `esp32/src/icons/` are generated by
`esp32/tools/genicons.py` straight from the source art, at the two sizes the
display needs. They derive from the MET Norway / Yr weather symbols at

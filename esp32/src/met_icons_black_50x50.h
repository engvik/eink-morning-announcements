...
// Definitions live in met_icons_black_50x50.cpp. The extern declarations give
// them external linkage, so the data exists once instead of once per
// translation unit.

extern const unsigned char met_bitmap_black_50x50_snowshowers_night[];
extern const unsigned char met_bitmap_black_50x50_heavyrain[];
extern const unsigned char met_bitmap_black_50x50_heavyrainandthunder[];
extern const unsigned char met_bitmap_black_50x50_sleet[];
extern const unsigned char met_bitmap_black_50x50_snow[];
...
extern const unsigned char met_bitmap_black_50x50_lightsleetshowers_day[];
extern const unsigned char met_bitmap_black_50x50_heavysnowshowers_night[];
extern const unsigned char met_bitmap_black_50x50_lightsleet[];
extern const unsigned char met_bitmap_black_50x50_heavysleet[];
extern const unsigned char met_bitmap_black_50x50_lightsnow[];
extern const unsigned char met_bitmap_black_50x50_heavysnow[];
extern const unsigned char met_bitmap_black_50x50_clearsky_day[];
extern const unsigned char met_bitmap_black_50x50_clearsky_polartwilight[];
extern const unsigned char met_bitmap_black_50x50_clearsky_night[];
extern const unsigned char met_bitmap_black_50x50_fair_day[];
extern const unsigned char met_bitmap_black_50x50_fair_polartwilight[];
extern const unsigned char met_bitmap_black_50x50_fair_night[];
extern const unsigned char met_bitmap_black_50x50_partlycloudy_day[];
extern const unsigned char met_bitmap_black_50x50_partlycloudy_polartwilight[];
extern const unsigned char met_bitmap_black_50x50_partlycloudy_night[];
extern const unsigned char met_bitmap_black_50x50_cloudy[];
extern const unsigned char met_bitmap_black_50x50_rainshowers_day[];
...
extern const unsigned char met_bitmap_black_50x50_sleetshowers_night[];
